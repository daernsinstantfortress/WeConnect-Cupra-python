...
from weconnect_cupra import weconnect_cupra, addressable
...
def main():
    ...
    weConnect = weconnect_cupra.WeConnect(username=args.username, password=args.password, updateAfterLogin=False, loginOnInit=False)
    print('#  Login')
    weConnect.login()
